...
def model_test(weight, img_name, beam_size = 3):
...
def model_on_images_test(weight, img_dir, beam_size = 3):
	imgs = []
	captions = {}
...
if __name__ == '__main__':
	...
	print(model_test(weight, test_image))
	print(model_on_images_test(weight, test_img_dir, beam_size=3))
